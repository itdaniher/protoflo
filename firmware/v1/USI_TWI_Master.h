...
* Date              Friday, 06/06/10		MODIFIED FOR USE WITH ATTINY85
* Updated by        itd
*
*
...
*	8MHz. Fast mode is probably possible, but would need a faster clock
*	and has not been tested.
*
*	12/15/08	Added declaration of USI_TWI_Start_Memory_Read	-jkl
*	06/06/10	Changed code from configed for attiny2313 to attiny85. -itd
****************************************************************************/
